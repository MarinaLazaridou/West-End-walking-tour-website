...
var pois = {
    ...
    "features": [
	{
			...
			"properties": {
						...
						"id":"0",
						"popupContent":"<b>Trafalgar Square</b> is a historic part of Central London. Its development started back in the 19th century and it gradually involved to a unique square with remarkable statues and fountains <br>(www.london.gov.uk/about-us/our-building-and-squares/trafalgar-square).", 
    ...
    },
	{
			...
			"properties": {
				...
				"id":"1",
				"popupContent":"<b>Leicester Square</b> was designed in the 17th century. It consists of a park with four statues and an impressive William Shakespeare fountain. It is surrounded by pedestrian streets and many entertainment buildings, restaurants and pubs<br>(en.wikipedia.org/wiki/Leicester_Square).",
    ...
    },
	{
			...
			"properties": {
				"name":"Covent Garden",
				"id":"2",
				"popupContent":"<b>Covent Garden</b> is a big pedestrian area and it is known as a shopping and dinning district in the centre of London. It is a place with many street performers who entertain and impress the attendants. It started being developed in the 7th century <br>(www.coventgarden.london/visit).",
    ...
    },
	{
			...
			"properties": {
				...
				"id":"3",
				"popupContent":"<b>St Paul's Church</b> was established in the early 17th century and refurbished in the late 18th century. It is also known as the 'Actor's Church', as it was connected with the first two theatres that were the considered as the first West End theatres. It currently holds shows, concerts, events and foundraisers <br>(actorschurch.org/about-us/the-church-and-the-theatre/).",
    ...
    },
    {
			...
			"properties": {
				...
				"id":"4",
				"popupContent":"<b>Victoria Embankment Gardens</b> is a park by the Thames with a remarkable design. It opened in 1865 and it contains many statues and memorials. It hosts events during the summertime, which attract the visitors <br>(www.westminster.gov.uk/my-parks/parks/victoria-embankment-gardens/).",
    ...
    },
	{
			...
			"properties": {
				"name": "Chinatown",
				"id":"5",
				"popupContent":"<b>Chinatown</b> is an ethnic enclave that consists of Chinese restaurants, souvenir shops and other places for entertainment and leisure. It is a beautiful and well-designed area with a great ethnic ambience, and it also contains an outstanding high Chinese gate <br>(en.wikipedia.org/wiki/Chinatown,_London).",
